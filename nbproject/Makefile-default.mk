...
SOURCEFILES_QUOTED_IF_SPACED=newfile.S
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newfile.o: newfile.S  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newfile.o.d 
	@${RM} ${OBJECTDIR}/newfile.o 
	@${RM} ${OBJECTDIR}/newfile.o.ok ${OBJECTDIR}/newfile.o.err 
	${MP_CC} $(MP_EXTRA_AS_PRE)  -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1 -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/newfile.o.d"  -o ${OBJECTDIR}/newfile.o newfile.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/newfile.o.asm.d",--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_SIMULATOR=1 -mdfp="${DFP_DIR}"
	@${FIXDEPS} "${OBJECTDIR}/newfile.o.d" "${OBJECTDIR}/newfile.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/newfile.o: newfile.S  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/newfile.o 
	@${RM} ${OBJECTDIR}/newfile.o.ok ${OBJECTDIR}/newfile.o.err 
	${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/newfile.o.d"  -o ${OBJECTDIR}/newfile.o newfile.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/newfile.o.asm.d",--gdwarf-2 -mdfp="${DFP_DIR}"
	@${FIXDEPS} "${OBJECTDIR}/newfile.o.d" "${OBJECTDIR}/newfile.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
